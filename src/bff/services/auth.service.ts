...
export class AuthService {
   ...
   * Sign up a new user
   */
  async signUp(input: SignUpInput, callbackURL: string = "/dashboard", headers?: Headers) {
    try {
   ...
   */
  async signIn(input: SignInInput, callbackURL: string = "/dashboard", headers?: Headers) {
    try {
