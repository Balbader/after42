...
// Stores core user profile and identity information.
...
// Tracks active login sessions and associated metadata.
...
// Stores linked auth provider accounts and credentials.
...
// Manages time-limited verification codes and tokens (e.g. email).
