    ...
    <div className="w-full max-w-2xl mx-auto p-6 space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Upload a job post file (PDF, Word, or text) to extract structured data for challenge
          generation
        </p>
      </div>
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2 text-sm">
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <span className="font-medium">{result.data.extractedData.title}</span>

                  <span className="text-muted-foreground">Company:</span>
                  <span className="font-medium">{result.data.extractedData.company}</span>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-1 mt-1">
                    {result.data.extractedData.requiredSkills.map((skill, i) => (
                      <span
                        key={i}
