	...
	if (submission.status === 'submitted' || submission.status === 'scoring') {
		return (
			<div className='mx-auto max-w-lg px-6 py-16 text-center'>
				<p className='font-(family-name:--font-fraunces) text-[22px] italic text-[#1C1917]'>
					Submitted {submittedAt}
				</p>
				<p className='mt-4 font-(family-name:--font-dm-sans) text-base text-[#78716C]'>
					Your code is locked and under review.
				</p>
				<p className='mt-6 flex items-center justify-center gap-2 font-(family-name:--font-dm-sans) text-[13px] text-[#78716C]'>
					<span
		...
		return (
			<div className='mx-auto max-w-lg px-6 py-16 text-center'>
				...
				<div className='mt-8 flex items-baseline justify-center gap-1'>
					...
					<span className='font-(family-name:--font-dm-sans) text-2xl text-[#78716C]'>
						/100
					</span>
				</div>
				<p className='mt-6 font-(family-name:--font-dm-sans) text-base text-[#78716C]'>
					Results are in.
				</p>
			</div>
		);
	...
	if (submission.status === 'failed') {
		return (
			<div className='mx-auto max-w-lg px-6 py-16 text-center'>
				...
				<p className='mt-4 font-(family-name:--font-dm-sans) text-sm text-[#78716C]'>
