      ...
      >
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground sm:text-xl">
            ...
            you can do with custom technical challenges — and let companies
            hire on proof, not paperwork.
          </p>
      ...
      >
        <div className="container mx-auto max-w-3xl text-center">
          ...
          <p className="mt-6 text-lg font-medium text-foreground">
            Think of it as &ldquo;LinkedIn meets HackerRank&rdquo; — built by and
            for the 42 ecosystem.
          </p>
        </div>
      </section>
            ...
            <li>
              <Card className="h-full border-border">
                <CardHeader>
                  ...
                  <CardTitle className="text-lg">Company posts a role</CardTitle>
                  <CardDescription>
            ...
            <li>
              <Card className="h-full border-border">
                <CardHeader>
                  ...
                  <CardTitle className="text-lg">AI builds the challenge</CardTitle>
                  <CardDescription>
