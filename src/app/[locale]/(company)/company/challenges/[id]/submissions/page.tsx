		...
		<RecruiterPage>
			...
			{rows.length === 0 ? (
				...
				<>
							...
							<div className='mt-4 grid gap-3 sm:grid-cols-3'>
								{topPicks.map((row) => {
									...
									return (
										...
										>
											<div>
												<p className='font-(family-name:--font-dm-sans) text-[13px] font-medium text-(--a42-text)'>
													Candidate{' '}
											...
											<Link
												...
												className='mt-4 inline-flex items-center gap-1 font-(family-name:--font-dm-sans) text-[13px] font-medium text-(--a42-accent) hover:underline'
											>
												{t('topPickReview')}
					...
					<div className='mt-10 overflow-hidden rounded-2xl border border-(--a42-border) bg-(--a42-surface) shadow-[0_1px_2px_rgba(28,25,23,0.04)] dark:shadow-[0_1px_3px_rgba(0,0,0,0.45)]'>
