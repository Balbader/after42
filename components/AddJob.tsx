		...
		<div className="p-6 max-w-4xl mx-auto">
			...
			<div className="mb-8">
				...
				<p className="text-gray-400">
					Create a new opportunity and our AI will generate a custom
					technical challenge aligned with your requirements.
				</p>
			</div>
						...
						<CardContent className="space-y-4">
							...
							<div className="text-sm text-gray-600">
								...
								<ul className="list-disc list-inside space-y-1">
									...
									<li>
										Mention required skills and experience
									</li>
									<li>
										Highlight company culture and benefits
									</li>
									<li>
										Be specific about what you're looking
										for
									</li>
								</ul>
							</div>
							...
							<div className="mt-4 p-4 bg-gradient-to-r from-[#00ADB5]/10 to-[#008B94]/10 border border-[#00ADB5]/30 rounded-lg shadow-lg shadow-[#00ADB5]/10">
								<div className="flex items-start gap-3">
									...
									<div className="text-sm">
										<p className="font-medium text-[#00ADB5] mb-1">
											AI Challenge Generation
										</p>
										<p className="text-gray-400">
											Our AI will automatically create a
											custom technical challenge based on
											this job description, including
											evaluation rubrics aligned with your
											role requirements.
										</p>
									</div>
								</div>
