		...
		recentReports: [
			{
				...
				description:
					'Comprehensive overview of AI challenge performance for January 2025',
				date: '2025-01-31',
				status: 'Ready',
				type: 'PDF',
			},
			...
			},
			{
				...
				description:
					'Current status of 42 students in the hiring pipeline',
				date: '2025-01-29',
				status: 'Generating',
				type: 'PDF',
			},
		...
		<div className="p-6 max-w-7xl mx-auto">
			...
			<div className="mb-8">
				...
				<p className="text-base text-gray-400 leading-relaxed">
					Generate and view detailed reports on AI-powered hiring
					challenges and performance analytics.
				</p>
			</div>
					...
					<CardContent>
						<div className="space-y-4">
							{reportsData.recentReports.map((report) => (
								<div
									key={report.id}
									className="flex items-start justify-between p-5 border border-[#1A1A1A] rounded-xl bg-[#0A0A0A] hover:border-[#00ADB5]/30 hover:bg-[#0F0F0F] transition-all duration-200 group"
								>
									<div className="flex-1 space-y-3">
										<div className="flex items-center gap-3">
											<h4 className="font-medium text-gray-200 text-base leading-tight group-hover:text-white transition-colors duration-200">
												{report.title}
											</h4>
											<Badge
												className={`${getStatusColor(report.status)} font-medium border`}
											>
												{report.status}
											</Badge>
										</div>
					...
					<CardContent>
						<div className="space-y-6">
							{reportsData.departmentBreakdown.map((dept) => (
								<div
									key={dept.department}
									className="space-y-3 p-4 rounded-lg bg-[#0A0A0A] border border-[#1A1A1A] hover:border-[#00ADB5]/30 transition-all duration-200"
								>
			...
			<Card className="mt-8 bg-gradient-to-br from-[#0F0F0F] to-[#0A0A0A] border-[#1A1A1A] relative overflow-hidden">
				...
				<CardContent className="relative">
					<div className="grid grid-cols-1 md:grid-cols-3 gap-4">
						<Button
							variant="outline"
							className="flex items-center gap-3 h-20 justify-start p-6 border-[#1A1A1A] bg-[#0A0A0A] text-gray-300 hover:bg-[#1A1A1A] hover:text-white hover:border-[#00ADB5]/50 transition-all duration-200 group"
						>
