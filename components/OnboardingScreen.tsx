...
const onboardingSteps = [
	{
		...
		description:
			'The exclusive hiring marketplace for 42 Network students where AI-powered technical challenges replace traditional résumés.',
		icon: '🚀',
	},
	{
		title: 'AI-Generated Challenges',
		description:
			'Our AI creates custom technical challenges based on your job requirements, evaluating candidates through real-world problem-solving.',
		icon: '⚡',
	},
	{
		title: 'Skills Over Résumés',
		description:
			'Watch 42 students prove their abilities through hands-on challenges. See their scores, peer evaluations, and campus affiliations.',
		icon: '🎯',
	},
];
	...
	return (
		<div className="min-h-screen flex items-center justify-center bg-black p-4 relative overflow-hidden">
			...
			<div className="absolute inset-0 overflow-hidden pointer-events-none">
				...
				<div
					className="absolute bottom-1/3 right-1/4 w-96 h-96 bg-[#008B94] rounded-full blur-[140px] opacity-20 animate-pulse"
