...
export function Team() {
	...
	const departmentGroups = teamData.members.reduce(
		(groups, member) => {
		...
		<div className="p-6 max-w-7xl mx-auto">
			...
			<div className="mb-8">
				...
				<p className="text-base text-gray-400 leading-relaxed">
					Manage your hiring team members, roles, and permissions for
			...
			<div className="space-y-4">
				{Object.entries(departmentGroups).map(
					([department, members]) => {
						...
						const filteredDeptMembers = members.filter(
							(member) =>
								member.name
									.toLowerCase()
						...
						return (
							<Card
								key={department}
								className="overflow-hidden border-[#1A1A1A] bg-gradient-to-br from-[#0F0F0F] to-[#0A0A0A]"
							>
								<Collapsible>
											...
											<div className="flex items-center justify-between">
												<div className="flex items-center gap-4">
													...
													<div className="flex items-center gap-3">
														...
														<Badge
															variant="secondary"
															className="bg-[#00ADB5]/10 text-[#00ADB5] border border-[#00ADB5]/30 font-medium px-3 py-1"
														>
															{stats.total}{' '}
															members
														</Badge>
									...
									<CollapsibleContent>
										<CardContent className="pt-0 pb-6 px-6">
											<div className="border-t border-[#1A1A1A] pt-6">
												<div className="space-y-4">
													{filteredDeptMembers.map(
														(member) => (
															<div
																key={member.id}
																className="flex items-center justify-between p-5 border border-[#1A1A1A] rounded-xl bg-[#0A0A0A] hover:bg-[#0F0F0F] hover:border-[#00ADB5]/30 transition-all duration-200 group"
															>
																<div className="flex items-center space-x-4">
																	...
																	<div className="space-y-1">
																		<div className="flex items-center gap-3">
																			<h4 className="font-medium text-gray-200 text-base group-hover:text-white transition-colors duration-200">
																				{
																					member.name
																				}
																			</h4>
																			<Badge
																				className={`${getStatusColor(member.status)} font-medium text-xs px-2 py-1 border`}
																			>
																				{
																					member.status
																				}
																...
																<div className="flex items-center gap-8">
																	<div className="flex items-center gap-6 text-sm">
																		<div className="text-center">
																			<div className="font-medium text-gray-200 text-base">
																				{
																					member
																						.stats
																						.jobsPosted
																	...
																	<div className="flex gap-2">
																		<Button
																			size="sm"
																			variant="outline"
																			className="h-9 px-4 font-medium border-[#1A1A1A] bg-[#0F0F0F] text-gray-400 hover:bg-[#1A1A1A] hover:text-[#00ADB5] hover:border-[#00ADB5]/50 transition-all duration-200"
																		>
																			Edit
																		</Button>
																		<Button
																			size="sm"
																			variant="ghost"
																			className="h-9 w-9 p-0 text-gray-500 hover:text-[#00ADB5] hover:bg-[#1A1A1A] transition-all duration-200"
																		>
																			<svg
																				className="w-4 h-4"
																				fill="none"
							...
							<div className="flex-1">
								<div className="text-sm">
									...
									<span className="text-gray-500">
										{' '}
										reviewed 5 new challenge submissions for
						...
						<div className="flex items-center gap-4 py-3 px-4 rounded-lg hover:bg-[#1A1A1A]/50 transition-colors duration-200">
							...
							<div className="flex-1">
								<div className="text-sm">
									...
									<span className="text-gray-500">
										{' '}
										scheduled 3 technical interviews for
										this week
									</span>
								</div>
							</div>
						...
						<div className="flex items-center gap-4 py-3 px-4 rounded-lg hover:bg-[#1A1A1A]/50 transition-colors duration-200">
							...
							<div className="flex-1">
								<div className="text-sm">
									...
									<span className="text-gray-500">
										{' '}
										posted new AI-powered UX Designer
										opportunity
									</span>
								</div>
							</div>
						...
						<div className="flex items-center gap-4 py-3 px-4 rounded-lg hover:bg-[#1A1A1A]/50 transition-colors duration-200">
							...
							<div className="flex-1">
								<div className="text-sm">
									...
									<span className="text-gray-500">
										{' '}
										updated AI challenge requirements for
