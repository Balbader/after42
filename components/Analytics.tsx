		...
		<div className="p-6 max-w-7xl mx-auto">
			...
			<div className="mb-8">
				...
				<p className="text-gray-400">
					Deep insights into your hiring process and AI challenge
					performance metrics.
				</p>
			</div>
					...
					<CardContent>
						<div className="space-y-4">
							{analyticsData.sources.map((source) => (
								<div
									key={source.name}
									className="flex items-center justify-between p-4 border border-[#1A1A1A] rounded-lg bg-[#0A0A0A] hover:border-[#00ADB5]/30 transition-all duration-200"
								>
									<div className="flex-1">
										<div className="flex items-center gap-2 mb-1">
											...
											<Badge
												className={`${getSourceColor(source.rate)} font-medium border`}
											>
									...
									<div className="text-right ml-4">
										<div className="w-24 bg-[#1A1A1A] rounded-full h-2">
											<div
												...
												style={{
													width: `${Math.min(source.rate * 5, 100)}%`,
												}}
											/>
										</div>
									</div>
							...
							{analyticsData.timeToHire.map((stage) => (
								<div key={stage.stage} className="space-y-2">
									<div className="flex justify-between items-center">
										...
										<span
											className={`text-sm font-medium ${getPerformanceColor(stage.days, stage.target)}`}
										>
											{stage.days} days
										</span>
									</div>
									<div className="w-full bg-[#1A1A1A] rounded-full h-2">
										<div
											...
											style={{
												width: `${Math.min((stage.days / stage.target) * 50, 100)}%`,
											}}
										/>
									</div>
						...
						<div className="space-y-3">
							...
							<ul className="space-y-2 text-sm text-gray-400">
								<li className="flex items-start gap-2 p-2 rounded-lg hover:bg-[#1A1A1A]/50 transition-colors duration-200">
									...
									Increase 42 Alumni Network engagement
									programs
								</li>
								<li className="flex items-start gap-2 p-2 rounded-lg hover:bg-[#1A1A1A]/50 transition-colors duration-200">
									<div className="w-2 h-2 bg-gradient-to-br from-[#00ADB5] to-[#008B94] rounded-full mt-1.5 flex-shrink-0 shadow-lg shadow-[#00ADB5]/50" />
