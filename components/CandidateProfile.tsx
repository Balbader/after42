				...
				<div className="flex items-center gap-3 mb-4">
					...
					<div>
						...
						<p className="text-gray-400">
							42 Student applying for {job.title} in{' '}
							{job.department}
						</p>
					</div>
				</div>
				...
				<div className="lg:col-span-1 space-y-6">
						...
						<CardContent className="p-6">
							<div className="text-center space-y-4">
								...
								<div>
									...
									<Badge
										className={`mt-2 ${getStatusColor(candidate.status)} border font-medium`}
									>
										{candidate.status}
									</Badge>
								</div>
					...
					<Card className="bg-gradient-to-br from-[#0F0F0F] to-[#0A0A0A] border-[#1A1A1A]">
						...
						<CardContent className="space-y-3">
							<Button
								variant="outline"
								className="w-full justify-start border-[#1A1A1A] bg-[#0F0F0F] text-gray-400 hover:bg-[#1A1A1A] hover:text-[#00ADB5] hover:border-[#00ADB5]/50 transition-all duration-200"
							>
								<svg
									className="w-4 h-4 mr-2 text-[#00ADB5]"
									fill="none"
									stroke="currentColor"
									viewBox="0 0 24 24"
								>
							...
							<div className="flex flex-wrap gap-2">
								{candidate.skills?.map((skill, index) => (
									<Badge
										key={index}
										variant="secondary"
										className="bg-[#00ADB5]/10 text-[#00ADB5] border border-[#00ADB5]/30 font-medium"
									>
										{skill}
									</Badge>
								)) || (
							...
							<div className="space-y-3">
								{candidate.linkedIn && (
									<a
										...
										className="flex items-center gap-3 p-3 bg-[#0A0A0A] rounded-lg border border-[#1A1A1A] hover:border-[#00ADB5]/50 transition-all duration-200 group"
									>
										<svg
										...
										<span className="text-gray-300 group-hover:text-[#00ADB5] transition-colors duration-200">
											LinkedIn Profile
										</span>
									</a>
								)}
						...
						<CardContent className="relative">
							<div className="flex gap-2 flex-wrap">
								<Button
									size="sm"
									variant="outline"
									className="bg-blue-950/30 text-blue-400 border-blue-900/50 hover:bg-blue-950/50 hover:border-blue-800 transition-all duration-200"
								>
									Mark as New
								</Button>
								<Button
									size="sm"
									variant="outline"
									className="bg-yellow-950/30 text-yellow-400 border-yellow-900/50 hover:bg-yellow-950/50 hover:border-yellow-800 transition-all duration-200"
								>
									Mark as Reviewed
								</Button>
								<Button
									size="sm"
									variant="outline"
									className="bg-purple-950/30 text-purple-400 border-purple-900/50 hover:bg-purple-950/50 hover:border-purple-800 transition-all duration-200"
								>
									Schedule Interview
								</Button>
								<Button
									size="sm"
									variant="outline"
									className="bg-green-950/30 text-green-400 border-green-900/50 hover:bg-green-950/50 hover:border-green-800 transition-all duration-200"
								>
									Mark as Hired
								</Button>
								<Button
									size="sm"
									variant="outline"
									className="bg-red-950/30 text-red-400 border-red-900/50 hover:bg-red-950/50 hover:border-red-800 transition-all duration-200"
								>
									Mark as Rejected
								</Button>
							</div>
