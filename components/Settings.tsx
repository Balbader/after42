...
import { Switch } from '../figma/src/components/ui/switch';
import {
	Card,
	CardContent,
	CardHeader,
...
export function Settings({ currentUser }: SettingsProps) {
	...
	const getProviderColor = (provider: string) => {
		switch (provider) {
			...
			default:
				return 'bg-[#00ADB5]/10 text-[#00ADB5] border-[#00ADB5]/30';
		}
	};
		...
		<div className="p-6 max-w-4xl mx-auto">
			...
			<div className="mb-8">
				...
				<p className="text-gray-400">
					Manage your account settings and AI-powered hiring
					preferences.
				</p>
			</div>
						...
						<div className="flex items-center space-x-4">
							...
							<div className="space-y-2">
								<div className="flex items-center gap-2">
									...
									<Badge
										className={`${getProviderColor(currentUser?.authProvider || 'email')} border font-medium`}
									>
										{getProviderLabel(
								...
								<Button
									variant="outline"
									size="sm"
									className="border-[#1A1A1A] bg-[#0F0F0F] text-gray-400 hover:bg-[#1A1A1A] hover:text-[#00ADB5] hover:border-[#00ADB5]/50 transition-all duration-200"
								>
									<svg
				...
				<Card className="bg-gradient-to-br from-[#0F0F0F] to-[#0A0A0A] border-[#1A1A1A]">
					...
					<CardContent className="space-y-4">
						<div className="space-y-3">
							{['google', 'github', 'microsoft'].map(
								(provider) => (
									<div
										key={provider}
										className="flex items-center justify-between p-4 border border-[#1A1A1A] rounded-lg bg-[#0A0A0A] hover:bg-[#0F0F0F] hover:border-[#00ADB5]/30 transition-all duration-200"
									>
					...
					<CardContent className="space-y-6">
						...
						<div className="flex items-center justify-between p-4 rounded-lg hover:bg-[#0F0F0F] transition-colors duration-200">
							<div className="space-y-0.5">
								...
								<p className="text-sm text-gray-500">
									Get notified when students submit AI
									challenges
								</p>
							</div>
							<Switch
						...
						<div className="flex items-center justify-between p-4 rounded-lg hover:bg-[#0F0F0F] transition-colors duration-200">
							<div className="space-y-0.5">
								...
								<p className="text-sm text-gray-500">
									Get weekly summaries of AI-powered hiring
									activity
								</p>
							</div>
							<Switch
				...
				<Card className="bg-gradient-to-br from-[#0F0F0F] to-[#0A0A0A] border-[#1A1A1A] relative overflow-hidden">
					...
					<CardContent className="space-y-4 relative">
						<div className="space-y-2">
							...
							<p className="text-sm text-gray-500 mb-3">
								Download a copy of your hiring data and
