			...
			{filteredCandidates.length === 0 ? (
					...
					<CardContent className="text-center py-12">
						<div className="flex flex-col items-center gap-4">
							...
							<p className="text-gray-500">
								No 42 students found matching your criteria.
							</p>
						</div>
					</CardContent>
				</Card>
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
					{filteredCandidates.map((candidate) => (
						<Card
							key={candidate.id}
							className="bg-gradient-to-br from-[#0F0F0F] to-[#0A0A0A] border-[#1A1A1A] hover:border-[#00ADB5]/50 hover:shadow-lg hover:shadow-[#00ADB5]/20 transition-all duration-200 group"
						>
								...
								<div className="flex items-start space-x-4">
									...
									<div className="flex-1 min-w-0">
										<div className="flex items-center justify-between mb-2">
											...
											<Badge
												className={`${getStatusColor(candidate.status)} border font-medium text-xs`}
											>
												{candidate.status}
											</Badge>
										</div>
