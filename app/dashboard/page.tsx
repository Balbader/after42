...
export default function App() {
	...
	const [candidates, setCandidates] = useState<Candidate[]>([
		// Frontend Developer candidates
		{
			...
			summary:
				'Experienced frontend developer with a passion for creating user-friendly applications. Skilled in React, TypeScript, and modern web technologies.',
		...
		},
		{
			...
			education: '42 Paris',
			summary:
				'Full-stack developer specializing in frontend technologies. Strong background in Vue.js and modern JavaScript frameworks.',
		...
		},
		{
			...
			education: '42 USA',
			summary:
				'Creative frontend developer with expertise in React and Angular. Passionate about building accessible and performant web applications.',
		...
		// UX Designer candidates
		{
			...
			education: '42 Seoul',
			summary:
				'User-centered designer with a focus on creating intuitive and engaging digital experiences. Experienced in design systems and prototyping.',
		...
		},
		{
			...
			summary:
				'Senior UX designer with extensive experience in user research and design systems. Skilled in creating cohesive and scalable design solutions.',
		...
		// Backend Engineer candidates
		{
			...
			education: '42 Silicon Valley',
			summary:
				'Senior backend engineer with expertise in scalable system design and cloud architecture. Experienced in building high-performance APIs.',
		...
		},
		{
			...
			education: '42 Tokyo',
			summary:
				'Backend developer specializing in Java and Spring Boot. Strong experience in microservices architecture and database design.',
	...
	const addJob = (
		newJob: Omit<Job, 'id' | 'candidatesCount' | 'datePosted'>,
	) => {
		const job: Job = {
			...newJob,
			id: Date.now().toString(),
	...
	return (
		<div className="flex h-screen bg-black">
			...
			<main className="flex-1 overflow-auto bg-gradient-to-br from-black via-[#0A0A0A] to-black">
				{currentScreen === 'dashboard' && (
					<Dashboard
						...
						onViewCandidates={(jobId) =>
							handleNavigate('candidates', jobId)
						}
				...
				{currentScreen === 'candidate-profile' &&
					selectedCandidateId && (
						<CandidateProfile
							candidate={
								candidates.find(
				...
				{currentScreen === 'add-job' && <AddJob onAddJob={addJob} />}
